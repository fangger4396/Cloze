...
model = BiLSTM()
model.model.fit([dataset.X_source[0], dataset.X_source[1]], dataset.Y_source, batch_size=32, epochs=1, shuffle=True,
                verbose=True)
model.model.evaluate(dataset.X_target, dataset.Y_target, verbose=True)
...
model_new.model.fit(dataset.X_target, dataset.Y_target, batch_size=32, epochs=1, shuffle=True,
                    verbose=True)
